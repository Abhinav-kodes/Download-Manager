...
void DownloadWindow::onDownloadClicked() {
    ...
    QString output = QFileDialog::getSaveFileName(this, "Save File",defaultName,filter);
...
void DownloadWindow::onDownloadComplete(bool success) {
    if (success) {
        ...
        QMessageBox::critical(this, "Download Failed", "There was an error downloading the file.");
    }
}